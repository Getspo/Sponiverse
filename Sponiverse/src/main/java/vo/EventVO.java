...
public class EventVO {
	 private int event_idx, event_sports_idx, event_addrcode, event_max_joiner, event_price, user_idx, event_viewCount;
	    private String event_loc, event_name, event_addr, event_addrdetail, event_thumbnail, event_content, event_paymethod, event_ticketname,
	            event_contact_name, event_contact_email, event_contact_tel, event_bank, event_account, event_account_name, event_ticket_open;
	    private LocalDateTime event_h_start, event_h_end, event_r_start, event_r_end, event_createdate;
