		...
		<div class="apply_form">
			<div class="info_line">
				<div class="event_info">
					...
					<div class="event_date">${event.getFormattedEventHStart()}~${event.getFormattedEventHEnd()}</div>
					<div class="event_addr">${event.event_addr}${event.event_addrdetail}</div>
				</div>

				<div class="event_ticket">
					<div class="ticket_details">
						<div id="ticketname">${event.event_ticketname}</div>
				...
				<div class="apply_info">
					<div class="apply_info_title">
						...
						<p class="subtitle">
							신청 정보는 신청내역 페이지에서 확인할 수 있습니다. &nbsp;
							<a href="javascript:" onclick="location.href='applyEvent_list.do?user_idx=${user.user_idx}'">신청 내역 확인하기 ></a>
						</p>
					</div>
					<div class="user_name">
						<p id="name">
					...
					<div class="user_gender">
						...
						<label>
							<input type="radio" id="order_gen" name="order_gen" value="male" required>남성
						</label> 
						<label>
							<input type="radio" id="order_gen" name="order_gen" value="female" required>여성
						</label>
					</div>
						...
						<div class="option_btn">
							<c:if test="${event.event_price > 0}">
								...
								<div class="account_comment">
									...
									<div id="comment_ment">
										<span><b><fmt:formatDate value="${currentDate}" pattern="MM월 dd일" /></b> 이전에 입금을 완료해 주세요.</span> <span>기한 내 입금이 확인되지 않을 경우, 신청은 <b>자동 취소</b>됩니다.
										</span>
									</div>
								</div>
							</c:if>
