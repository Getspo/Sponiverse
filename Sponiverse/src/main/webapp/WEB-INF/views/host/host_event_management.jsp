...
<body>
	...
	<article id="event_info_section" class="event_info_section">
		...
		<div class="event_info_wrapper">
			...
			<div>
				<p class="event_info">(행사번호 : ${event.event_idx}) ${event.event_name}</p>
			</div>
					...
					<div class="join_box_sub">
						...
						<div class="join_chart">
							<div class="join_chartsub">
								<div>
									<p class="join_chart_count">${event.event_max_joiner}<span class="join_chart_count_unit">&nbsp;명</span>
									</p>
									<p class="join_chart_info_percent">
										모집정원의&nbsp;<span>${percent}%</span>
									</p>
								</div>
					...
					<div class="join_box_sub2">
						<div class="join_cancle">
							...
							<p class="join_chart_count">
								7<span class="join_chart_count_unit">&nbsp;명</span>
							</p>
						</div>
					</div>
				</div>
