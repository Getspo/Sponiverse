...
<link rel="stylesheet"
	href="/getspo/resources/css/host/host_sidebar.css">
	...
	<div class="sidebar">
		...
		<ul class="menu">
			<li class="menu-item"><a href="#" class="menu-link"
				data-target="submenu1">이벤트관리</a>
				<ul class="submenu" id="submenu1">
					<li><a href="javascript:"
						onclick="location.href='host_event_management.do?event_idx=${event.event_idx}'">이벤트개요</a></li>
					<li><a href="javascript:"
						onclick="location.href='host_event_modify.do?event_idx=${event.event_idx}'">이벤트수정</a></li>
