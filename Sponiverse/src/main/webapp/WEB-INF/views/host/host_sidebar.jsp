        ...
        <ul class="menu">
            <li class="menu-item">
                ...
                <ul class="submenu" id="submenu1">
                    <li><a href="javascript:" onclick="location.href='host_event_management.do?event_idx=${event.event_idx}'">행사개요</a></li>
                    <li><a href="javascript:" onclick="location.href='host_event_modify.do?event_idx=${event.event_idx}'">행사수정</a></li>
                    <li><a href="javascript:" onclick="location.href='host_event_notice.do?event_idx=${event.event_idx}'">공지/안내작성</a></li>
