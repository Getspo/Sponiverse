		...
		<form>
			<div class="withdraw_input">
				...
				<div class="Guidelines">
					<p class="Guide_first">- 회원탈퇴 신청 시, 회원님 이메일 아이디로 즉시 탈퇴 처리가 진행됩니다.</p>
					<p class="Guide">- 회원가입 시, 입력한 회원정보는 모두 삭제됩니다.</p>
					<p class="Guide">- 회원탈퇴가 완료된 이메일은 본인을 포함한 타인 모두 재사용이나 복구가 불가능합니다.</p>
					<p class="Guide">- 회원탈퇴 완료 후, 삭제된 행사와 접수내역의 데이터는 복구되지 않습니다.</p>
					<p class="Guide_last">- 개설한 행사나 참가한 행사 중에 진행중인 행사가 있을 시, 탈퇴가 불가능합니다. 행사 내역 삭제나 취소를 후에 탈퇴 부탁드립니다.</p>
				</div>
